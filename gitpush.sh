...
echo 'add a remote pseudo for the cimenergy14 repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/cimenergy14
